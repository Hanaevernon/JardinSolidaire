...
const MesReservationsJardinsPage = () => {
        ...
        {reservationsConfirmees.length > 0 && (
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
              ...
              Jardins confirmés ({reservationsConfirmees.length})
            </h2>
            <div className="space-y-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div className="text-sm text-gray-600">
                          <div className="flex items-center mb-2">
                            <FontAwesomeIcon icon={faCalendarAlt} className="mr-2 w-4" />
                            <span>Confirmé le {new Date(reservation.date_reservation).toLocaleDateString()}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mt-3 p-3 bg-green-50 rounded-lg">
                        <p className="text-sm text-green-800">
                          ...
                          Jardin accessible ! Contactez le propriétaire pour organiser votre visite.
                        </p>
                      </div>
                    </div>
...
export default MesReservationsJardinsPage;